 (function($){
    ...
    function Swiper(options,wrap){
        ...
        this.flag = true;
        this.spotSize = options.spotSize;
    }
    //初始化结构与行为
    ...
    Swiper.prototype.createDom = function (){
        ...
        var leftBtn = $('<div class="my-swiper-btn my-swiper-lbtn iconfont">&#xe645;</div>');
        var rightBtn = $('<div class="my-swiper-btn my-swiper-rbtn iconfont">&#xe618;</div>');
